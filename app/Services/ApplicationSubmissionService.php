...
class ApplicationSubmissionService
{
    ...
    public function submit(Request $request, JobPosting $posting, Applicant $applicant): Application
    {
        ...
        // Neon pooled PostgreSQL connections can leave a connection in an aborted state when a
        // large transaction includes multiple writes. Keep the submission flow as independent writes
        // instead of wrapping the whole workflow in a single DB transaction.
